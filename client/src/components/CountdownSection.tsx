...
import flower1 from '@assets/flower1_1759741371018.png';
import flower8 from '@assets/flower8_1759741371010.png';
...
const CountdownSection = () => {
  ...
  useEffect(() => {
    const targetDate = new Date('December 12, 2025 13:00:00').getTime();
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto text-center relative">
        {/* Flower Decorations */}
        <img src={flower1} alt="" className="absolute top-0 left-4 md:left-12 w-20 md:w-28 opacity-80 ml-[-30px] mr-[-30px]" />
        <img src={flower8} alt="" className="absolute top-0 right-4 md:right-12 w-24 md:w-32 opacity-80 transform rotate-12 ml-[-44px] mr-[-44px]" />
